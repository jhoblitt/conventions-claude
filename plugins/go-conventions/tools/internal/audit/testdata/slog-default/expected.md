...
| logging | stderr-json | gap | migration | no non-test file builds a slog.NewJSONHandler | the JSON handler writes to stderr; stdout is program output | migrate area: logging |

19 gaps (17 tooling, 2 migration), 6 ok, 5 skipped
