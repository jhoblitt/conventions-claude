...
| --- | --- | --- | --- | --- | --- | --- |
| toolchain | go-directive | gap | tooling | go 1.27, toolchain go1.27.1 | go 1.27, the minor only, and no toolchain line | set go 1.27 in go.mod and drop any toolchain line |
