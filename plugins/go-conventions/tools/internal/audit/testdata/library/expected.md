...
| version | package | skipped | none | library | internal/version reads debug.ReadBuildInfo |  |
| layout | cmd | skipped | none | library | every package main lives in cmd/<name> |  |
| layout | pkg-dir | ok | none | pkg/ in a library module | no pkg/ in a module that ships a binary |  |
| deps | cli | skipped | none | library | cobra builds every command tree |  |
| deps | config | skipped | none | library | viper resolves flags, environment, and config file |  |
...
| logging | stderr-json | skipped | none | library | the JSON handler writes to stderr; stdout is program output |  |

17 gaps (16 tooling, 1 migration), 5 ok, 8 skipped
